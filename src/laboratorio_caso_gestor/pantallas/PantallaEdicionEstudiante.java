 ...
 * @author brall
 */
public class PantallaEdicionEstudiante extends javax.swing.JFrame {

    /**
     * Creates new form PantallaEdicionEstudiante
     */
    public PantallaEdicionEstudiante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaEdicionEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaEdicionEstudiante().setVisible(true);
            }
        });
    }
